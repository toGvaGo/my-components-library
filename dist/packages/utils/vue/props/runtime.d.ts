...
import { GpProp, EpPropConvert, GpPropInput, GpPropMergeType, IfEpProp, IfNativePropType, NativePropType } from './types';
...
export declare const buildProps: <Props extends Record<string, {
    [gpPropKey]: true;
} | NativePropType | GpPropInput<any, any, any, any, any>>>(props: Props) => { [K in keyof Props]: IfEpProp<Props[K], Props[K], IfNativePropType<Props[K], Props[K], EpPropConvert<Props[K]>>>; };
