...
import type GpTooltip from '@/components/tooltip'
...
export const useSelect = (props: ISelectProps, emit) => {
  ...
  const tooltipRef = ref<InstanceType<typeof GpTooltip> | null>(null)
  const tagTooltipRef = ref<InstanceType<typeof GpTooltip> | null>(null)
